...
public class interpolationManager {
	...
	public interpolationManager(ArrayList<Float> data) {
		System.out.println("Data" + data.size());

		ArrayList<Double> dataDouble = data.stream().map(Double::valueOf)
		...
		for (int i = 0; i < groupedData.size(); i++) {
			...
			data1 = replaceNullWitNan(groupedData.get(i));
...
//						"------------------------------------------------------------------------------------------");
	...
	public ArrayList<ArrayList<Double>> group(ArrayList<Double> data) {
		int groupSize = 2880;//----------------------------------------------------------------------------------------------------->We take one month data into consideration for cubical interpolation
